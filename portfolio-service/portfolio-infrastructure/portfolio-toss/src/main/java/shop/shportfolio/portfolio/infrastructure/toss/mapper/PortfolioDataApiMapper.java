package shop.shportfolio.portfolio.infrastructure.toss.mapper;
...
import shop.shportfolio.portfolio.application.exception.DataApiMapperException;
import shop.shportfolio.portfolio.infrastructure.toss.dto.PaymentTossAPIResponse;

@Slf4j
@Component
public class PortfolioDataApiMapper {

    private final ObjectMapper objectMapper;

    public PortfolioDataApiMapper(ObjectMapper objectMapper) {
