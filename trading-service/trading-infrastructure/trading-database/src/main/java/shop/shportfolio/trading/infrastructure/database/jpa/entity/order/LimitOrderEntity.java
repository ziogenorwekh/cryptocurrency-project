...
public class LimitOrderEntity extends OrderEntity {
    ...
    public LimitOrderEntity(String orderId, UUID userId, String marketId, String orderSide, BigDecimal quantity,
    ...
    public static class Builder {
        ...
        public LimitOrderEntity build() {
            return new LimitOrderEntity(orderId, userId, marketId, orderSide, quantity, price, remainingQuantity, orderType, orderStatus, createdAt);
        }
    }
}
