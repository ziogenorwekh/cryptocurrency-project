...
public class QMarketItemEntity extends EntityPathBase<MarketItemEntity> {
    ...
    public final EnumPath<shop.shportfolio.trading.domain.valueobject.MarketStatus> marketStatus = createEnum("marketStatus", shop.shportfolio.trading.domain.valueobject.MarketStatus.class);

    public final StringPath marketWarning = createString("marketWarning");

    public final NumberPath<java.math.BigDecimal> tickPrice = createNumber("tickPrice", java.math.BigDecimal.class);
