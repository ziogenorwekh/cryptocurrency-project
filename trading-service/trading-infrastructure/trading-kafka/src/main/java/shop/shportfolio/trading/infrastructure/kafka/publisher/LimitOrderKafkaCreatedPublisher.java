...
@Slf4j
@Component
public class LimitOrderKafkaCreatedPublisher implements LimitOrderCreatedPublisher {
    ...
    @Autowired
    public LimitOrderKafkaCreatedPublisher(KafkaPublisher<String, LimitOrderAvroModel> kafkaPublisher,
