...
public class TradingDataMapper {
    ...
    public TickerTrackResponse marketTickerResponseDtoToTickerTrackResponse(MarketTickerResponseDto dto) {
        return new TickerTrackResponse(
                ...
                dto.getChange(),
                BigDecimal.valueOf(dto.getChangePrice()),
                BigDecimal.valueOf(dto.getChangeRate()),
                BigDecimal.valueOf(dto.getSignedChangePrice()),
                BigDecimal.valueOf(dto.getSignedChangeRate()),
                BigDecimal.valueOf(dto.getTradeVolume()),
                BigDecimal.valueOf(dto.getAccTradePrice()),
                BigDecimal.valueOf(dto.getAccTradePrice24h()),
                BigDecimal.valueOf(dto.getAccTradeVolume()),
                BigDecimal.valueOf(dto.getAccTradeVolume24h()),
                BigDecimal.valueOf(dto.getHighest52WeekPrice()),
                dto.getHighest52WeekDate(),
                BigDecimal.valueOf(dto.getLowest52WeekPrice()),
