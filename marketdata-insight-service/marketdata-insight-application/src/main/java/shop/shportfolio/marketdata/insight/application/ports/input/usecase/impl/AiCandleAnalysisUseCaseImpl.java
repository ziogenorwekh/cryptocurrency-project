...
@Slf4j
@Component
public class AiCandleAnalysisUseCaseImpl implements AiCandleAnalysisUseCase {
    ...
    public AiCandleAnalysisUseCaseImpl(OpenAiPort openAiPort, BithumbApiPort bithumbApiPort,
    ...
    @Transactional
    public void analyzeMarketData(PeriodType periodType) {
